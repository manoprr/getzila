...
public class BannerAdepter extends RecyclerView.Adapter<BannerAdepter.BannerViewHolder>{
    ...
    public BannerAdepter(Context context, ArrayList<String> stringArrayList, OnClickItem onClickItem) {
